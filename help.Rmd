...
You can click on a flux result in the "Gasfluxes" table and you can see the plot of the chamber calculation by the gasfluxes package (if the flux was calculated on the shiny server).